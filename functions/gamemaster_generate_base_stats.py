...
for i in range(1,810):
    base_stats_dict[i] = get_stats_from_gamemaster(i,gamemaster_data,pokemon_names)


base_stats_file_name = '../static/pokemon_base_stats.json'
with open(base_stats_file_name, 'w') as fp:
    json.dump(base_stats_dict, fp)
